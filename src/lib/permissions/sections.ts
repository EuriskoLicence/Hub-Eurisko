...
export const SECTIONS_META: Record<SectionCode, { label: string; description: string; sortOrder: number; area: string }> = {
  ...
  EXPENSES:                  { label: 'Nota spese',                description: 'Inserimento proprie note spese',                                                                             sortOrder:  4, area: 'Nota spese' },
  EXPENSES_AMENDMENT:        { label: 'Rettifica nota spese',      description: 'Richiesta rettifica proprie note spese',                                                                     sortOrder:  5, area: 'Nota spese' },
  CLIENTS_VIEW:              { label: 'Visualizzazione clienti',   description: 'Visualizzazione clienti, progetti e commesse',                                                               sortOrder:  6, area: 'Clienti' },
