// ISO 3166-1 alpha-2 — ordinati per nome italiano
// File puro (no 'use client') — importabile da server e client components
...
/** Restituisce il nome del paese dato il codice ISO alpha-2, o il codice stesso se non trovato. */
