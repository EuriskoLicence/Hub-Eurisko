...
import { getTimesheetExtraYearData } from './[year]/[month]/actions'
...
export default async function TimesheetExtraListPage({
  searchParams,
}: {
  ...
  const { months, summary, currentYear: curYear } = await getTimesheetExtraYearData(validYear)
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href={`/timesheet-extra?year=${validYear - 1}`}
      ...
      {/* Griglia mesi */}
      <TimesheetYearGrid months={months} year={validYear} basePath="/timesheet-extra" />
