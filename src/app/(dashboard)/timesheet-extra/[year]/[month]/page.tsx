...
import { getTimesheetExtraPageData } from './actions'
...
export default async function TimesheetExtraGridPage({ params }: Props) {
  ...
  const data = await getTimesheetExtraPageData(year, month)
